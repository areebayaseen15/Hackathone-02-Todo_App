...
## Current Feature: Intermediate Todo Features

**Specification**: `specs/1-intermediate-features/spec.md`
**Plan**: `specs/1-intermediate-features/plan.md`

### New Features to Implement

1. **Task Priorities** (high/medium/low)
   - Add `Priority` enum to models
   - Default priority: MEDIUM
   - Case-insensitive validation

2. **Task Categories/Tags**
   - Optional category field (max 50 chars)
...
5. **Sort Tasks**
   ...
   - Secondary sort by created_at for ties

### Implementation Resources

- **Data Model**: `specs/1-intermediate-features/data-model.md`
- **Research**: `specs/1-intermediate-features/research.md`
- **Quickstart**: `specs/1-intermediate-features/quickstart.md`
- **Contracts**: `specs/1-intermediate-features/contracts/`
  - `add-task.md` - Add task with priority/category
  - `search-tasks.md` - Search by keyword
  - `filter-tasks.md` - Filter by status/priority/category
  - `sort-tasks.md` - Sort by priority/alphabetically
